...
/**
 * Servlet implementation class ActualizarEleccionController
 */
@WebServlet("/ActualizarEleccionController")
public class ActualizarEleccionController extends HttpServlet {
     ...
     */
    public ActualizarEleccionController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//String inicio = eleccion.getFechainicio().getYear()+"-"+(eleccion.getFechainicio().getMonth()+1)+"-"+eleccion.getFechainicio().getDay();
		//String fin = eleccion.getFechafin().getYear()+"-"+(eleccion.getFechafin().getMonth()+1)+"-"+eleccion.getFechafin().getDay();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (esValido(request.getParameter("nombre")) && esValido(request.getParameter("cargo"))
			...
			request.getRequestDispatcher("actualizareleccion.jsp").forward(request,response);
		}
	}

...
/**
 * Servlet implementation class ListaEleccionController
 */
@WebServlet("/ListaEleccionController")
public class ListaEleccionController extends HttpServlet {
     ...
     */
    public ListaEleccionController() {
        super();

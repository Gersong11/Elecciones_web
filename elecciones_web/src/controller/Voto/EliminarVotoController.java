...
/**
 * Servlet implementation class EliminarVotoController
 */
@WebServlet("/EliminarVotoController")
public class EliminarVotoController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Voto voto = this.votoDao.find(id);

                        ...
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl"  action="RegistrarTipodocumentoController" method="post">
                                <div class="">
                                    ...
                                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="descripcion" name="descripcion" type="text" required="" placeholder="Cédula de Ciudadanía" aria-label="Name">
                                </div>
                                <div class="mt-6">
